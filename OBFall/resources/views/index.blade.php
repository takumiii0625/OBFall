...
<body>
            ...
            <div class="wrap">
                ...
                <nav class="nav-01">
                    <ul>
                        ...
                        <li class="link"><a href="#company">Company</a></li>
                        <li class="link"><a href="#recruit">Contact</a></li>
    ...
    <main>
        <div id="about" class="service">
            ...
            <div class="fadein-scroll fadein-from-up" style="background-color: #ffffff; width: 80%; padding: 10px 10px; margin: auto;     margin-bottom: 100px;">

                <p class="sub" style="padding: 20px 20px;">
                    私たちOBFall株式会社の社名の由来は、リンカーンの有名なゲティスバーグ演説、独立宣言の以下3つの頭文字からきています。<br class="br-sp" />
                    関わった<strong class="highlight">「government &nbsp;<strong class="letter">o</strong>f the people, <strong class="letter">b</strong>y the people,<strong class="letter">f</strong>or the people（人民の、人民による、人民のための政治）」</strong>
            ...
            <ul>
                <h1 class="fadein-scroll fadein-from-up"><span>3つの柱</span></h1>
                <li class="service-item1">
                    <img class="fadein-scroll fadein-from-down" src="image/logo1.jpg">
                    <a class="fadein-scroll fadein-from-down">

                        <p class="catch"> 理念採用</p>
                ...
                <li class="service-item2">
                    <img class="fadein-scroll fadein-from-down" src="image/logo2.jpg">
                    <a class="fadein-scroll fadein-from-down">

                        <p class="catch"> ES＝CS</p>
                ...
                <li class="service-item3">
                    <img class="fadein-scroll fadein-from-down" src="image/6c40ac7b707e13491fda6a6b4f02d82d.jpg">
                    <a class="fadein-scroll fadein-from-down">
                        <p class="catch">マルチスキル</p>
        ...
        <div class="vision" id="service">
            <div class="wrap">
                ...
                <ul class="fadein-scroll fadein-from-down">
                    <li>
                        <p class="catch">
                            <br class="br-sp" />フリーランス
                        </p>
                        <p class="sub">会社員でありながらフリーランスエンジニアと同等の報酬形態をとっているため、人材の差別化が図れます。</p>
                    </li>
                    <li>
                        <p class="catch">
                            <br class="br-sp" />報酬形態
                    ...
                    <li>
                        ...
                        <p class="sub">スキル面のみならず質の高いエンジニアを採用、育成しているため他社にはない新しい形での価値提供を実現いたします。</p>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="about" id="company">
            <div class="wrap">
                <h1 class="fadein-scroll fadein-from-up"><span>会社概要</span></h1>
                <div class="about-content-inner-wrap">
                    <ul class="fadein-scroll fadein-from-up">
                        ...
                        <li>
                            ...
                            <p class="about-data">コンサルティング/システム開発、受託開発/教育・研修/アウトソーシング</p>
                        </li>
                        <li>
                            <p class="about-head">本社住所</p>
                            <p class="about-data">〒105-0022<br>東京都港区海岸1-2-3<br>汐留芝離宮ビルディング 21F<br>
                                <!--<a class="map-link">GoogleMap<i class="fa-solid fa-arrow-up-right-from-square"></i></a>-->
                            </p>
                        </li>
                    </ul>
                    <img class="fadein-scroll fadein-from-down" src="image/IMG_0218-4.jpeg">
                </div>
            </div>
            <div class="wrap">
                <a class="other fadein-scroll fadein-from-left" href="{{ route('contact') }}" target="_blank" rel="noopener noreferrer">採用サイトはこちら
            ...
            <div class="wrap">
                ...
                <div class="recruit-jobs fadein-scroll fadein-from-down">
                    ...
                    <div class="jobs">
                        ...
                        <a class="fadein-scroll fadein-from-down" href="{{ route('contact') }}" target="_blank" rel="noopener noreferrer">採用情報・エントリー<i class="fa-solid fa-arrow-right"></i></a>
    ...
    <!--<div class="jobs">
        <a id="scroll-action" class="scroll-action fadein-from-down" style="opacity: 0; visibility: hidden;">採用サイトはこちら<i class="fa-solid fa-arrow-right"></i></a>
    </div> window.addEventListener('scroll', function() {
        var scrollAction = document.getElementById('scroll-action');
        if (window.pageYOffset > 200) {
            scrollAction.style.opacity = '1';
            scrollAction.style.visibility = 'visible';
        } else {
            scrollAction.style.opacity = '0';
            scrollAction.style.visibility = 'hidden';
        }
    });-->
